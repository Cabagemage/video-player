...
function App() {
    ...
    const audioMarks: AudioPlayerMark[] = [{start: 0, end: 7, imageSrc: "https://imgv3.fotor.com/images/blog-cover-image/part-blurry-image.jpg"},{start: 20,end: 40, imageSrc: "https://johnstillk8.scusd.edu/sites/main/files/main-images/camera_lense_0.jpeg"}, {end: 250, start: 150, imageSrc: "https://metricool.com/wp-content/uploads/jason-blackeye-364785-2.jpg"}]
    return (
        <div className={"flex"}>
